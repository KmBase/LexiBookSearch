...
# 创建数据库
mysql -u root -p
CREATE DATABASE LPMS CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
```
...
spring:
  datasource:
    url: jdbc:mysql://localhost:3306/LPMS?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai
    username: root
