...
public class FileUploadResult {
    ...
    public FileUploadResult(String filePath, int pageCount) {
        this.filePath = filePath;
        this.pageCount = pageCount;
        this.isDuplicate = false;
    }

    public FileUploadResult(String filePath, int pageCount, Long duplicateBookId, String duplicateBookTitle, String picUrl) {
        this.filePath = filePath;
        this.pageCount = pageCount;
